...
/**
 * The {@code Alien} class represents an alien entity in the game. It extends
 * {@code Pane} and manages images representing different states of the alien,
...
public class Alien extends Pane {
	...
	/**
	 * Switches between the first and second image of the alien. If the alien is not
	 * alive, this method does nothing.
	 */
	...
	/**
	 * Changes the alien's image to an explosion image and sets its state as not
	 * alive.
	 */
	public void explode() {
